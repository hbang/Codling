...
%ctor {
	HBPreferences *preferences = [HBPreferences preferencesForIdentifier:@"ws.hbang.codling"];
	[preferences registerBool:&enabled default:YES forKey:@"Enabled"];
	[preferences registerInteger:&hudStyle default:HBCDHUDStyleDark forKey:@"HUDStyle"];
}
